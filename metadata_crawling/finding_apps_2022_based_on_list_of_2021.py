"""""This part is use to crawled the metadata based on the apps list of 2021
    The result return the list that still available in 2022 and 
    the list that already remove from google play store in 2022
"""
...
metadata_2022 = '/home/budi/adblocker_project/adblocker_code/metadata_crawling/metadata_2022_based_on_2021/'
list_metadata = '/home/budi/adblocker_project/adblocker_code/metadata_crawling/metadata_2022_based_on_2022_list.csv'
list_failed_to_scrap = '/home/budi/adblocker_project/adblocker_code/metadata_crawling/failed_to_scrap_in_2022_based_on_2021_list.csv'
...
with open(app_list_2021,'r') as app_id:
    for item in app_id:
        ...
        result_path = metadata_2022+item_id
        try:
...
for item in managed_to_scrap_list:
    app_path = metadata_2022+item+'.txt'
    print(app_path)
    try:
