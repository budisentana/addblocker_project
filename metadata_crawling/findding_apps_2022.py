...
res_path = '/home/budi/adblocker_project/adblocker_code/metadata_crawling/res_by_keyword_2022/'
csv_path = '/home/budi/adblocker_project/adblocker_code/metadata_crawling/add_metadata_2022.csv'
keyword = ['adblock','adsblock',"'ad block'","'ads block'"]
# scraper_path = '/home/budi/adblocker_project/adblocker_code/metadata_crawling/metadata_scraper.js'
...
for item in keyword:
    ...
    with open(target_file_path) as target:
        ...
        for target_item in target_json:
            ...
            os.system('node scrap_similar_app '+target_app_id)

"""Read JSON reasult from the scraper
    This part is use to created a raw list of 2022 apps based on keyword search as well as the similar apps
